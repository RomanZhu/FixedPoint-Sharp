...
namespace FixedPoint {
    ...
    public struct fp3x3 : IEquatable<fp3x3> {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp3x3 operator *(fp3x3 lhs, fp3x3 rhs) {
            return new fp3x3(lhs.c0 * rhs.c0, lhs.c1 * rhs.c1, lhs.c2 * rhs.c2);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp3x3 operator *(fp3x3 lhs, fp rhs) {
            return new fp3x3(lhs.c0 * rhs, lhs.c1 * rhs, lhs.c2 * rhs);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp3x3 operator *(fp lhs, fp3x3 rhs) {
            return new fp3x3(lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp3x3 operator -(fp3x3 val) {
            return new fp3x3(-val.c0, -val.c1, -val.c2);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(fp3x3 lhs, fp3x3 rhs) {
